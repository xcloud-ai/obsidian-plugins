...
| [xu-quiet-outline](https://github.com/xcloud-ai/xu-quiet-outline) | 大纲 | 侧边栏大纲树：点击跳转、双向定位、层级滑条、拖拽改层级、双链标题着色、搜索过滤、虚拟滚动长文档流畅、彩虹缩进线与样式定制；v2.0.0 零框架重写（基于 quiet-outline 裁剪重构） | 2.2.3 |
...
| [xu-mermaid-lazy-render](https://github.com/xcloud-ai/xu-mermaid-lazy-render) | 流程图懒加载 | 接管 Mermaid 渲染，视口外流程图延迟到滚动接近时渲染，图表多的笔记打开不卡顿；点击流程图全屏看大图（拖动平移、滚轮缩放、双击适应/原尺寸） | 1.1.0 |
