...
| [xu-quiet-outline](https://github.com/xcloud-ai/xu-quiet-outline) | 大纲 | 侧边栏大纲树：点击跳转、双向定位、层级滑条、拖拽改层级、双链标题着色、搜索过滤、虚拟滚动长文档流畅、彩虹缩进线与样式定制；v2.0.0 零框架重写（基于 quiet-outline 裁剪重构） | 2.0.2 |
...
| [xu-view-mode](https://github.com/xcloud-ai/xu-view-mode) | 打开模式记忆 | frontmatter open-mode 定义打开时阅读/编辑模式，兼容 obsidianUIMode 老笔记，等价写法七值兼容，出厂默认阅读，首次打开生效不打扰，性能无感 | 1.0.4 |
